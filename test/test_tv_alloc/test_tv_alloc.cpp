...
void test_bringup_limit_respects_configured_ceiling() {
    const TVAllocOutput o = alloc_f(1000.0f, 0.0f, unlimited(), TV_PARAMS);
    TEST_ASSERT_FLOAT_WITHIN(0.01f, TV_PARAMS.motor_current_max_a, (float)o.torque_L);
    TEST_ASSERT_FLOAT_WITHIN(0.01f, TV_PARAMS.motor_current_max_a, (float)o.torque_R);
}
...
int main(int, char **) {
    ...
    RUN_TEST(test_bringup_limit_respects_configured_ceiling);
